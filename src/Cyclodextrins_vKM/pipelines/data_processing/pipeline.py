...
def create_pipeline(**kwargs):
    return Pipeline(
        [
            node(func=ConvertMol, inputs='alCyDNH_xyz', outputs='Molecule1', name='Create_Molecule1'),
            ...
            node(func=ConvertMol, inputs='alCyDNH2_xyz', outputs='Molecule2', name='Create_Molecule2'),
