...
def create_pipeline(**kwargs):
    return Pipeline(
        [
            node(func=ConvertMol, inputs='bI45Me2CyDNH_xyz', outputs='Molecule1', name='Create_Molecule1'),
            ...
            node(func=ConvertMol, inputs='bI45Me2CyDNH2_xyz', outputs='Molecule2', name='Create_Molecule2'),
