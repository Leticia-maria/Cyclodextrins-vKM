...
# Cyclodextrins_vKM documentation build
...
from Cyclodextrins_vKM import __version__ as release

# -- Project information -----------------------------------------------------

project = "Cyclodextrins_vKM"
author = "Kedro"
...
htmlhelp_basename = "Cyclodextrins_vKMdoc"
...
latex_documents = [
    (
        master_doc,
        "Cyclodextrins_vKM.tex",
        "Cyclodextrins_vKM Documentation",
        "Kedro",
        "manual",
    )
]
...
texinfo_documents = [
    (
        ...
        author,
        "Cyclodextrins_vKM",
        "Project Cyclodextrins_vKM codebase.",
        "Data-Science",
    )
]
